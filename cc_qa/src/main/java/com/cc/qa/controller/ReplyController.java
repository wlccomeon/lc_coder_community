...
import com.cc.qa.service.ReplyService;
...
public class ReplyController {
	...
	public Result findAll(){
		return Result.createBySuccess("查询成功",replyService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return Result.createBySuccess("查询成功",replyService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  Result.createBySuccess("查询成功",  new PageResult<Reply>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return Result.createBySuccess("查询成功",replyService.findSearch(searchMap));
    }
