...
import com.cc.user.service.AdminService;
...
public class AdminController {
	...
	public Result findAll(){
		return Result.createBySuccess("查询成功",adminService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return Result.createBySuccess("查询成功",adminService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  Result.createBySuccess("查询成功",  new PageResult<Admin>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return Result.createBySuccess("查询成功",adminService.findSearch(searchMap));
    }
