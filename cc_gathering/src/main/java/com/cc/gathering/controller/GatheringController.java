package com.cc.gathering.controller;
...
import com.cc.gathering.service.GatheringService;
...
public class GatheringController {
	...
	public Result findAll(){
		return Result.createBySuccess("查询成功",gatheringService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return Result.createBySuccess("查询成功",gatheringService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  Result.createBySuccess("查询成功",  new PageResult<Gathering>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return Result.createBySuccess("查询成功",gatheringService.findSearch(searchMap));
    }
